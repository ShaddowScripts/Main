        ...
        if Vis5 then
            ...
            if ESP.Health then
                if self.PrimaryPart.Parent:FindFirstChildOfClass("Humanoid") then 
                    self.Components.Distance.Text = "[".. math.floor((cam.CFrame.p - cf.p).magnitude).. "m]".. "[".. tostring(((1/self.PrimaryPart.Parent:FindFirstChildOfClass("Humanoid").MaxHealth) * self.PrimaryPart.Parent:FindFirstChildOfClass("Humanoid").Health) * 100).. "%]"
